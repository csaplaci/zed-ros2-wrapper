...
private:
  ...
  bool topic_publish_Rgb            = true;
  bool topic_publish_RgbGray        = true;
  bool topic_publish_RawRgb         = true;
  bool topic_publish_RawRgbGray     = true;
  bool topic_publish_Left           = true;
  bool topic_publish_LeftGray       = true;
  bool topic_publish_RawLeft        = true;
  bool topic_publish_RawLeftGray    = true;
  bool topic_publish_Right          = true;
  bool topic_publish_RightGray      = true;
  bool topic_publish_RawRight       = true;
  bool topic_publish_RawRightGray   = true;
  bool topic_publish_Depth          = true;
  bool topic_publish_DepthInfo      = true;
  bool topic_publish_Stereo         = true;
  bool topic_publish_RawStereo      = true;
  bool topic_publish_ConfMap        = true;
  bool topic_publish_Disparity      = true;
  bool topic_publish_Cloud          = true;
  bool topic_publish_Pose           = true;
  bool topic_publish_PoseStatus     = true;
  bool topic_publish_PoseCov        = true;
  bool topic_publish_Odom           = true;
  bool topic_publish_OdomStatus     = true;
  bool topic_publish_PosePath       = true;
  bool topic_publish_OdomPath       = true;
  bool topic_publish_GnssPose       = true;
  bool topic_publish_GnssPoseStatus = true;
  bool topic_publish_GeoPose        = true;
  bool topic_publish_GeoPoseStatus  = true;
  bool topic_publish_FusedCloud     = true;
  bool topic_publish_Marker         = true;
  bool topic_publish_Plane          = true;
  bool topic_publish_Imu            = true;
  bool topic_publish_ImuRaw         = true;
  bool topic_publish_ImuTemp        = true;
  bool topic_publish_ImuMag         = true;
  bool topic_publish_Pressure       = true;
  bool topic_publish_TempL          = true;
  bool topic_publish_TempR          = true;
  bool topic_publish_CamImuTransf   = true;
  // <---- Topic filter variables
