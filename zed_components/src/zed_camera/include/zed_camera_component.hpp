...
private:
  ...
  bool topic_disable_mPubRgb            = false;
  bool topic_disable_mPubRgbGray        = false;
  bool topic_disable_mPubRawRgb         = false;
  bool topic_disable_mPubRawRgbGray     = false;
  bool topic_disable_mPubLeft           = false;
  bool topic_disable_mPubLeftGray       = false;
  bool topic_disable_mPubRawLeft        = false;
  bool topic_disable_mPubRawLeftGray    = false;
  bool topic_disable_mPubRight          = false;
  bool topic_disable_mPubRightGray      = false;
  bool topic_disable_mPubRawRight       = false;
  bool topic_disable_mPubRawRightGray   = false;
  bool topic_disable_mPubDepth          = false;
  bool topic_disable_mPubDepthInfo      = false;
  bool topic_disable_mPubStereo         = false;
  bool topic_disable_mPubRawStereo      = false;
  bool topic_disable_mPubConfMap        = false;
  bool topic_disable_mPubDisparity      = false;
  bool topic_disable_mPubCloud          = false;
  bool topic_disable_mPubPose           = false;
  bool topic_disable_mPubPoseStatus     = false;
  bool topic_disable_mPubPoseCov        = false;
  bool topic_disable_mPubOdom           = false;
  bool topic_disable_mPubOdomStatus     = false;
  bool topic_disable_mPubPosePath       = false;
  bool topic_disable_mPubOdomPath       = false;
  bool topic_disable_mPubGnssPose       = false;
  bool topic_disable_mPubGnssPoseStatus = false;
  bool topic_disable_mPubGeoPose        = false;
  bool topic_disable_mPubGeoPoseStatus  = false;
  bool topic_disable_mPubFusedCloud     = false;
  bool topic_disable_mPubMarker         = false;
  bool topic_disable_mPubPlane          = false;
  bool topic_disable_mPubImu            = false;
  bool topic_disable_mPubImuRaw         = false;
  bool topic_disable_mPubImuTemp        = false;
  bool topic_disable_mPubImuMag         = false;
  bool topic_disable_mPubPressure       = false;
  bool topic_disable_mPubTempL          = false;
  bool topic_disable_mPubTempR          = false;
  bool topic_disable_mPubCamImuTransf   = false;
  // <---- Topic filter variables
