...
private:
  ...
  bool topic_publish_mPubRgb            = true;
  bool topic_publish_mPubRgbGray        = true;
  bool topic_publish_mPubRawRgb         = true;
  bool topic_publish_mPubRawRgbGray     = true;
  bool topic_publish_mPubLeft           = true;
  bool topic_publish_mPubLeftGray       = true;
  bool topic_publish_mPubRawLeft        = true;
  bool topic_publish_mPubRawLeftGray    = true;
  bool topic_publish_mPubRight          = true;
  bool topic_publish_mPubRightGray      = true;
  bool topic_publish_mPubRawRight       = true;
  bool topic_publish_mPubRawRightGray   = true;
  bool topic_publish_mPubDepth          = true;
  bool topic_publish_mPubDepthInfo      = true;
  bool topic_publish_mPubStereo         = true;
  bool topic_publish_mPubRawStereo      = true;
  bool topic_publish_mPubConfMap        = true;
  bool topic_publish_mPubDisparity      = true;
  bool topic_publish_mPubCloud          = true;
  bool topic_publish_mPubPose           = true;
  bool topic_publish_mPubPoseStatus     = true;
  bool topic_publish_mPubPoseCov        = true;
  bool topic_publish_mPubOdom           = true;
  bool topic_publish_mPubOdomStatus     = true;
  bool topic_publish_mPubPosePath       = true;
  bool topic_publish_mPubOdomPath       = true;
  bool topic_publish_mPubGnssPose       = true;
  bool topic_publish_mPubGnssPoseStatus = true;
  bool topic_publish_mPubGeoPose        = true;
  bool topic_publish_mPubGeoPoseStatus  = true;
  bool topic_publish_mPubFusedCloud     = true;
  bool topic_publish_mPubMarker         = true;
  bool topic_publish_mPubPlane          = true;
  bool topic_publish_mPubImu            = true;
  bool topic_publish_mPubImuRaw         = true;
  bool topic_publish_mPubImuTemp        = true;
  bool topic_publish_mPubImuMag         = true;
  bool topic_publish_mPubPressure       = true;
  bool topic_publish_mPubTempL          = true;
  bool topic_publish_mPubTempR          = true;
  bool topic_publish_mPubCamImuTransf   = true;
  // <---- Topic filter variables
